...
export class SectionAddComponent implements OnInit {
  ...
  save(){
    if(!this.title){
      this.toaster.open({text: "NECESITAS INGRESAR UN NOMBRE PARA LA SECCIÓN", caption: "VALIDACIÓN", type: 'danger'});
      return;
    }
    let data = {
      name: this.title,
    ...
    this.courseService.registerSection(data).subscribe((resp:any) => {
      ...
      this.toaster.open({text: "LA SECCIÓN SE REGISTRÓ CORRECTAMENTE", caption: "SUCCESS", type: 'success'});
    });
  }
